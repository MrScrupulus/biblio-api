...
class EditorTest extends TestCase
{
    ...
    public function testSetAndGetCreationDate(): void
    {
        ...
        $result = $this->editor->setCreationDate($creationDate);
        
        $this->assertInstanceOf(Editor::class, $result);
        $this->assertEquals($creationDate, $this->editor->getCreationDate());
    }

    public function testSetAndGetHeadOffice(): void
    {
        $headOffice = 'Paris, France';
        $result = $this->editor->setHeadOffice($headOffice);
        
        $this->assertInstanceOf(Editor::class, $result);
        $this->assertEquals($headOffice, $this->editor->getHeadOffice());
    }
